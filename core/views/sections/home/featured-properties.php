...
">
	<div class="
		awp-home-properties__container relative awp-container pb-24
		lg:pb-0
	">
		<div class="
		...
		<div class="
			awp-home-properties__list mt-10 grid grid-cols-1 gap-8
			lg:grid-cols-3 lg:mt-15 lg:gap-5
			2xl:mt-20 2xl:gap-8
		">
			<?php foreach ( $featured_properties as $property ) : ?>
				<article class="
					awp-home-properties__card rounded-[12px] border border-awp-grey-15 bg-awp-grey-08
					p-6
					lg:p-7
					2xl:p-9
				">
