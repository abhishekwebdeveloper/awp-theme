<?php
/**
 * Checkout template controller.
 *
 * @package abhishekWebDeveloper\AwpTheme\Plugins\Woocommerce\Checkout
 * @author  abhishekWebDeveloper.com
 */

namespace abhishekWebDeveloper\AwpTheme\Plugins\Woocommerce\Checkout;
...
class TemplateController {
	...
	public static function add_hooks(): void {
		// Do not proceed if current page is not Checkout or Order Received.
		if ( ! is_checkout() ) {
			return;
		}
